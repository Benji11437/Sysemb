...
selected_image = st.sidebar.selectbox("Choisissez une image :", images)
...
if selected_image:
    ...
    if run_button:
        ...
        # --- Étape 3 : afficher les 3 images après la segmentation ---
    ...
    st.info("⬅️ Sélectionnez une image dans la barre latérale pour commencer.")
